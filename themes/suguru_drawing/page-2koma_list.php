...
and
meta2.meta_value = 'single-2koma.php'
  ...
  <div class="contents">
    <div class="menu-sub">
      <div class="menu-sub-list">
          <a href="/2koma-list" class="selected">人気順</a>
          <a href="/2koma-list-new">新着順</a>
      </div>
    </div>
      ...
      <?php foreach( $the_pop_query as $pop_post ){?>
        <div class="painting-area pop-images">
          <a class="link-area" href="<?php echo get_permalink($pop_post->ID)?>">
            <div class="image"><img class="neta-img" src="<?php echo get_field('2koma_img_title', $pop_post->ID)['sizes']['medium'];?>" alt=""></div>
