...
<div class="container">
  <div class="contents">
    ...
    <div class="painting-area">
      <ul>
        <li class="image"><img class="neta-img" src="<?php echo get_field('4koma_img_title', $post->ID)['url'];?>" alt=""></li>
        <li class="image"><img class="neta-img" src="<?php echo get_field('4koma_img_1st', $post->ID)['url'];?>" alt=""></li>
        <li class="image"><img class="neta-img" src="<?php echo get_field('4koma_img_2nd', $post->ID)['url'];?>" alt=""></li>
        <li class="image"><img class="neta-img" src="<?php echo get_field('4koma_img_3rd', $post->ID)['url'];?>" alt=""></li>
        <li class="image"><img class="neta-img" src="<?php echo get_field('4koma_img_4th', $post->ID)['url'];?>" alt=""></li>
      </ul>
...
post.post_type = 'post'
and
meta1.meta_value = 'single-4koma.php'
    ...
    <?php 
      foreach( $recommend_post as $post ){
        ...
        <a class="recommend-post" href="<?php echo get_permalink($post->ID);?>">
          <li>
            <div class="recommend-image"><img src="<?php echo get_field('4koma_img_title', $post->ID)['sizes']['medium'];?>" alt="<?php echo $post->post_title ?>"></div>
