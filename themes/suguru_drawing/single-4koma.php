...
<div class="container">
  <div class="contents">
    ...
    <div class="painting-area">
      <div class="image"><img class="neta-img" src="<?php echo get_field('4koma_img_title', $post->ID)['url'];?>" alt=""></div>
      <div class="image"><img class="neta-img" src="<?php echo get_field('4koma_img_1st', $post->ID)['url'];?>" alt=""></div>
      <div class="image"><img class="neta-img" src="<?php echo get_field('4koma_img_2nd', $post->ID)['url'];?>" alt=""></div>
      <div class="image"><img class="neta-img" src="<?php echo get_field('4koma_img_3rd', $post->ID)['url'];?>" alt=""></div>
      <div class="image"><img class="neta-img" src="<?php echo get_field('4koma_img_4th', $post->ID)['url'];?>" alt=""></div>
